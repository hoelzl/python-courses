...
from othellite.core import Board, Field, PlayerColor, Position
...
class BoardTests:
    ...
    def test_initialize(self, board: Board):
        # Check that board is not the default board:
        assert board[0, 0] == Field.DARK
    ...
    def test_is_valid_move_against_border_pieces(self, board: Board):
        ...
        # We remove some pieces that might lead to valid moves against the
        # center.
    ...
    def test_play_move_light_2_3_against_initial_board(self, initial_board: Board):
        ...
        expected = BoardReader.board_from_string(type(initial_board), board_str)
    ...
    def test_play_move_light_2_0_against_board(self, board: Board):
        ...
        expected = BoardReader.board_from_string(type(board), board_str)
